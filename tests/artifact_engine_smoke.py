...
for frame in frames:
    ...
    assert (
        frost_artifact["enabled"]
        is False
    )

    assert (
        frost_artifact["applied"]
        is False
    )

    assert (
        frost_artifact["category"]
        == "glass"
    )

    assert (
        frost_artifact["stage"]
        == "pre_render"
    )
    ...
    assert (
        dust_artifact["enabled"]
        is False
    )

    assert (
        dust_artifact["applied"]
        is False
    )

    assert (
        dust_artifact["category"]
        == "glass"
    )
